    ...
    return (
      <div className="about-me-container">
        <div className="about-me-box">
          <img className="portrait" src="http://res.cloudinary.com/corgi1989/image/upload/c_scale,w_448/v1481000913/corgi-portrait_lxekge.jpg"/>
        ...
        <div className="about-me-links">
          ...
          <img className="about-resume" src="http://res.cloudinary.com/corgi1989/image/upload/v1481001378/document_icon_ohkrmi.png"/>
